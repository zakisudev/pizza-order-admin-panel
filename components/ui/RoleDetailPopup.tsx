    ...
    <div className="flex justify-center items-center bg-black/70 absolute z-50 top-0 bottom-0 right-0 left-0 inset-0">
      <div className="w-[600px] h-fit bg-white rounded-xl p-[10px] relative">
        <button
          ...
          onClick={() => setIsRoleDetailPopupOpen(false)}
        >
          <Image
            src={close}
            width={32}
              ...
              <div className="grid grid-cols-2 gap-6 px-4">
                <li className="flex gap-3 items-center">
                  <input
                    ...
                    id="updateStatus"
                    name="updateStatus"
                    checked={permissions?.includes('updateStatus')}
                ...
                <li className="flex gap-3 items-center">
                  <input
                    ...
                    name="seeCustomers"
                    className="rounded-md h-[18px] w-[18px]"
                    checked={permissions?.includes('seeCustomers')}
                    onChange={handleRoleChange}
                  />
                ...
                <li className="flex gap-3 items-center">
                  <input
                    ...
                    name="seeOrders"
                    className="rounded-md h-[18px] w-[18px]"
                    checked={permissions?.includes('seeOrders')}
                    onChange={handleRoleChange}
                  />
                ...
                <li className="flex gap-3 items-center">
                  <input
                    ...
                    name="createRoles"
                    className="rounded-md h-[18px] w-[18px]"
                    checked={permissions?.includes('createRoles')}
                    onChange={handleRoleChange}
                  />
                ...
                <li className="flex gap-3 items-center">
                  <input
                    ...
                    name="addUsers"
                    className="rounded-md h-[18px] w-[18px]"
                    checked={permissions?.includes('addUsers')}
                    onChange={handleRoleChange}
                  />
